...
EXPERIMENT_NAME=rubric_rm_qwen2.5_7B_LR${LR}_sky_filtered_code_1_5k_evidence_rubric_4k2k_separate_reward_2Epoch
...
# Task
TRAIN_TASK="gaotang/filtered_sky_code_1_5k_small_model"
EVAL_TASK="gaotang/filtered_sky_code_1_5k_small_model"
