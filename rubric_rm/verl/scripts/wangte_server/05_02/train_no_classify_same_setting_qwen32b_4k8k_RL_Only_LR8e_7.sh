...
EXPERIMENT_NAME=rubric_rm_qwen2.5_32B_LR${LR}_filtered_sky_code_8k_math_10k_cold_start_no_classify_same_setting_4k8k_0502
...
# Task
TRAIN_TASK="gaotang/05_02_ablation_no_classify_cold_start"
EVAL_TASK="gaotang/05_02_ablation_no_classify_cold_start"
