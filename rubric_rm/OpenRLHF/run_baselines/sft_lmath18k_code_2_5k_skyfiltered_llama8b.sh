...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --module openrlhf.cli.train_sft \
   --save_path /shared/nas2/xiusic/gaotang/skylab-v02-math-18k-code-2_5k-baseline/ckpt/llama3-8b-sft \
   --save_steps -1 \
   --logging_steps 1 \
   --eval_steps -1 \
   ...
   --zero_stage 3 \
   --learning_rate 5e-7 \
   --dataset gaotang/sky_v02_filtered_2_5kcode_18kmath_math_code_sky \
   --apply_chat_template \
