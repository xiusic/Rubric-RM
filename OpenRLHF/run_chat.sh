...
ray job submit --address="http://127.0.0.1:8265" \
   ...
   --save_path /shared/nas2/xiusic/ckpt/llama3-8b-rlhf-new \
   ...
   --init_kl_coef 0.01 \
   --prompt_data /shared/nas2/xiusic/wangyu/data/chat_data \
   ...
   --packing_samples \
   --save_steps 1280 \
   --ckpt_path /shared/nas2/xiusic/ckpt/llama3-8b-rlhf-new \
