...
EXPERIMENT_NAME=rubric_rm_qwen2.5_7B_LR${LR}_filtered_sky_code_8k_math_10k_rubric_evidence_classify_4k4k_PPO
SAVE_NAME=rubric_rm_qwen2.5_7B_LR${LR}_filtered_sky_code_8k_math_10k_rubric_evidence_classify_4k4k_PPO
SAVE_META_DIR=Your_dir
...
python3 -m rubric_rm.verl.trainer.main_ppo \
    ...
    critic.model.lr_warmup_steps_ratio=0.05 \
