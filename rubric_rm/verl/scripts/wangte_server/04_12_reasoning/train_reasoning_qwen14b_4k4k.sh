...
EXPERIMENT_NAME=rubric_rm_deepseek_r1_distilled_14B_LR${LR}_gaotang/filtered_sky_code_8k_math_10k_rubric_reasoning_4k4k
...
# Task
TRAIN_TASK="gaotang/gaotang/filtered_sky_code_8k_math_10k_rubric_reasoning"
