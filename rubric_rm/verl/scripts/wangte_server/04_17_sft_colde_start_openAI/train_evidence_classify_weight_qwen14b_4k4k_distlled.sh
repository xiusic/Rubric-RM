...
# ============SETTING PARAMETER===============
# Model Setting
MODEL_PATH=gaotang/qwen_14b_sky_filtered_code8k_math_10k_distilled_OpenAI
...
EXPERIMENT_NAME=rubric_rm_qwen2.5_14B_LR${LR}_filtered_sky_code_8k_math_10k_rubric_evidence_classify_weight_4k4k_distilled_OpenAI
