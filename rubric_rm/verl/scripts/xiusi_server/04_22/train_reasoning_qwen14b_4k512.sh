...
# Training Setting
LR=1.0e-6
GPU_MEM_UTILIZATION=0.7 # Lower this if you met OOM problem
TOTAL_EPISODES=1
SAVE_EVERY_STEP=100
...
MAX_RESPONSE_LENGTH=512 # Lower this if you met OOM problem
...
EXPERIMENT_NAME=rubric_rm_deepseek_r1_distilled_7B_LR${LR}_filtered_sky_code_8k_math_10k_rubric_reasoning_4k512
SAVE_NAME=rubric_rm_deepseek_r1_distilled_7B_LR${LR}_filtered_sky_code_8k_math_10k_rubric_reasoning_4k512
