...
ray job submit --address="http://127.0.0.1:8265" \
   ...
   --save_path /shared/nas2/xiusic/gaotang/ckpt/debug/qwen-1_5B-chat-easy-curriculum \
   ...
   --packing_samples \
   --save_steps 15 \
   --ckpt_path /shared/nas2/xiusic/gaotang/ckpt/debug/qwen-1.5B-chat-easy-curriculum \
   --use_wandb 7595e33990e2af809f914f13cefa202fc8fba1ee \
   --wandb_project Debug-Rubric-RM \
   --wandb_run_name debug-qwen-1.5b \
   --remote_rm_url /shared/nas2/xiusic/OpenRLHF/custom_reward_function.py \
   --verbose_training \
   --verbose_directory /shared/nas2/xiusic/gaotang/logs/debug/qwen-1_5B-chat-easy-curriculum \