...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --module openrlhf.cli.train_sft \
   --save_path /shared/nas2/xiusic/gaotang/skylab-v02-math-18k-code-2_5k-baseline/ckpt/qwen-7b-sft-sky_filtered_code_8k_math_10k \
   --save_steps -1 \
   --logging_steps 1 \
   --eval_steps -1 \
   ...
   --wandb_run_name Qwen-7b-sft-lr5e-7sky_filtered_code_8k_math_10k \