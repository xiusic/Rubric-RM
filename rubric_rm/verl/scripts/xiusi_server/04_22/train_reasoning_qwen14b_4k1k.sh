...
MAX_RESPONSE_LENGTH=1024 # Lower this if you met OOM problem
...
EXPERIMENT_NAME=rubric_rm_deepseek_r1_distilled_7B_LR${LR}_filtered_sky_code_8k_math_10k_rubric_reasoning_4k1k
SAVE_NAME=rubric_rm_deepseek_r1_distilled_7B_LR${LR}_filtered_sky_code_8k_math_10k_rubric_reasoning_4k1k
