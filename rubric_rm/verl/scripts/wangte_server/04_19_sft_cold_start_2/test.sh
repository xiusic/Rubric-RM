...
# Training Setting
LR=1.0e-6
GPU_MEM_UTILIZATION=0.2 # Lower this if you met OOM problem
TOTAL_EPISODES=1
SAVE_EVERY_STEP=100
TEST_EVERY_STEP=100000
TRAIN_BS=8           # Rollout batchsize. Could be arbitrary large, but must be divided by N_GPU.
PPO_MINI_BS=2        # Train batch size. Could be arbitrary large, must be the divisor of TRAIN_BS and be divided by N_GPU. Setting this equal to TRAIN_BS means strictly on-policy.
MAX_PROMPT_LENGTH=1024  # Lower this if you met OOM problem.
...
EXPERIMENT_NAME=test_sft_distill
SAVE_NAME=test_sft_distill
SAVE_META_DIR="/shared/nas2/xiusic/gaotang/ckpt/test"
