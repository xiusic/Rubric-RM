...
EXPERIMENT_NAME=rubric_rm_qwen2.5_32B_LR${LR}_filtered_sky_code_8k_math_10k_cold_start_same_setting_4k8k_0501
...
# Task
TRAIN_TASK="gaotang/filtered_sky_code_8k_math_10k_rubric_evidence_classify_weight"
EVAL_TASK="gaotang/filtered_sky_code_8k_math_10k_rubric_evidence_classify_weight"
