...
# ============SETTING PARAMETER===============
# Model Setting
MODEL_PATH=gaotang/qwen_32b_sky_filtered_code8k_math_10k_distilled_Claude_o3_0419
...
EXPERIMENT_NAME=rubric_rm_qwen2.5_32B_LR${LR}_filtered_sky_code_8k_math_10k_rubric_evidence_classify_weight_4k8k_distilled_Claude_o3_0419_ShuffleDataset
