deepspeed --include localhost:0,1,2,3,4,5,6,7 --module openrlhf.cli.train_sft \
   --save_path /shared/nas2/xiusic/gaotang/04_25_ablation_32b_sft_9k \
   --save_steps -1 \
   --logging_steps 1 \
   --eval_steps -1 \
   ...
   --zero_stage 3 \
   --learning_rate 5e-7 \
   --dataset gaotang/04_25_9k_distilled_sft_ablation \
   --apply_chat_template \
   ...
   --wandb_run_name Qwen-32b-sft-lr5e-704_25_9k_distilled_sft_ablation \