...
EXPERIMENT_NAME=rubric_rm_qwen2.5_7B_LR${LR}_sky_filtered_code_2_5k_math_18k_evidence_rubric_4k2k_separate_reward
SAVE_NAME=qwen2.5_7B_LR${LR}_evidence_rubric_4k2k_separate_reward_function
...
python3 -m rubric_rm.verl.trainer.main_ppo \
    ...
    default_local_dir=/shared/nas2/xiusic/gaotang/skylab-v02-math-18k-code-2_5k-baseline/
