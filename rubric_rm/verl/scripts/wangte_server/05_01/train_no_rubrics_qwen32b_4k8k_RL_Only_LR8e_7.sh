...
EXPERIMENT_NAME=rubric_rm_qwen2.5_32B_LR${LR}_filtered_sky_code_8k_math_10k_no_rubric_ablation_4k8k_0501
...
# Task
TRAIN_TASK="gaotang/05_01_ablation_no_rubrics_cold_start"
EVAL_TASK="gaotang/05_01_ablation_no_rubrics_cold_start"
