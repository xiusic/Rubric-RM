...
def convert_ds_to_sft():
    ...
    dataset.push_to_hub("gaotang/filtered_sky_code_8k_math_10k_rubric_sft")
...
def convert_ds_to_reasoning():
    ...
    for item in ds:
        ...
        context_messages.append([ 
            {
                'content': "Please act as an impartial judge and evaluate the quality of the responses provided by two AI Chatbots "
            "to the Client question displayed below. \n\n" + user_content + "\n\n"
...
def convert_weight_classifiy():
    ...
    for item in ds:
        ...
        context_message[0]['content'] = GPT_REVISED_SYSTEM_CLASSIFY_WEIGHT_PROMPT_EVIDENCE
        context_messages.append(context_message) 
    dataset = Dataset.from_dict({
        'context_messages': context_messages,
        'winner': winner
    })
    dataset.push_to_hub("gaotang/filtered_sky_code_8k_math_10k_rubric_evidence_classify_weight")
