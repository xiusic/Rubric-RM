...
# ============SETTING PARAMETER===============
# Model Setting
MODEL_PATH=/mnt/home/ziqi/hf_model/DeepSeek-R1-Distill-Qwen-32B
...
EXPERIMENT_NAME=rubric_rm_DeepSeek-R1-Distill-Qwen-32B_LR${LR}_filtered_sky_code_8k_math_10k_rubric_reasoning_4k8k
