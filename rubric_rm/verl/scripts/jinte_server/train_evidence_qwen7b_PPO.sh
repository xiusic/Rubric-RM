...
EXPERIMENT_NAME=rubric_rm_qwen2.5_7B_LR${LR}_sky_filtered_code_2_5k_math_18k_evidence_rubric_4k2k_separate_reward_PPO
SAVE_NAME=qwen2.5_7B_LR${LR}_evidence_rubric_4k4k_separate_PPO
