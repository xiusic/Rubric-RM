...
if __name__ == "__main__":
    ...
    # Logs 
    parser.add_argument("--verbose_training", action="store_true", default=False, help="Whether log samples during training") 
    parser.add_argument("--verbose_directory", type=str, default=None, help="If None, then log using save_dir/log, otherwise use it") 
